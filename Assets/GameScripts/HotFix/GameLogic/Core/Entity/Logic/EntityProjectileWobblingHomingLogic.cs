...
namespace GameLogic
{
    public class EntityProjectileWobblingHomingLogic : EntityHideSelfProjectileLogic
    {
        ...
        protected EntityTargetableLogic enemy;
        ...
        protected override void OnShow(object userData)
        {
            ...
            enemy = entityProjectileData.EntityTargetableLogic;

            Vector3 startingPoint = entityProjectileData.FiringPoint.position;
            ...
            Vector3 direction = entityProjectileData.FiringPoint.forward;
        ...
        void OnTargetLost(EntityTargetableLogic enemy)
        {
            enemy.OnHidden -= OnTargetLost;
            enemy.OnDead -= OnTargetLost;
            this.enemy = null;
