...
namespace GameLogic
{
    public class Targetter : MonoBehaviour
    {
        ...
        /// </summary>
        public event Action<EntityTargetableLogic> targetEntersRange;

        /// <summary>
        /// Fires when a targetable exits the target collider
        /// </summary>
        public event Action<EntityTargetableLogic> targetExitsRange;

        /// <summary>
        /// Fires when an appropriate target is found
        /// </summary>
        public event Action<EntityTargetableLogic> acquiredTarget;
        ...
        /// </summary>
        protected List<EntityTargetableLogic> m_TargetsInRange = new List<EntityTargetableLogic>();
        ...
        /// </summary>
        protected EntityTargetableLogic m_CurrrentTargetable;
        ...
        /// </summary>
        public EntityTargetableLogic GetTarget()
        {
        ...
        /// </summary>
        public List<EntityTargetableLogic> GetAllTargets()
        {
        ...
        protected virtual bool IsTargetableValid(EntityTargetableLogic targetable)
        {
        ...
        {
            var targetable = other.GetComponent<EntityTargetableLogic>();
        ...
        protected virtual EntityTargetableLogic GetNearestTargetable()
        {
            ...
            EntityTargetableLogic nearest = null;
            float distance = float.MaxValue;
            for (int i = length - 1; i >= 0; i--)
            {
                EntityTargetableLogic targetable = m_TargetsInRange[i];
        ...
        /// </summary>
        void OnTargetRemoved(EntityTargetableLogic target)
        {
